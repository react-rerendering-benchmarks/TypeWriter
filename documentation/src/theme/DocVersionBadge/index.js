...
export default memo(function DocVersionBadge() {
  ...
  if (versionMetadata.badge) {
    return <div className="flex">
                <div className="inline-block mb-2 mr-2">
                    <span className={` ${ThemeClassNames.docs.docVersionBadge} badge badge--primary`}>
                        <Translate id="theme.docs.versionBadge.label" values={{
      ...
      <div className="inline-block mb-2">
                        <span className={`badge ${getBadgeClass(difficultyLevel)}`}>
                            <Translate id="theme.docs.difficultyBadge.label" values={{
            difficultyLevel
          }}>
