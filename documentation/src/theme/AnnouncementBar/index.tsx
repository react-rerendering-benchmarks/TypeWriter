...
export default function AnnouncementBar(): JSX.Element | null {
  ...
  return <div className={`flex items-center justify-between p-0 bg-[#227c9d] text-white shadow-lg transition-all duration-300 ease-in-out ${isCloseable ? 'relative' : 'border-b'}`} role="banner">
