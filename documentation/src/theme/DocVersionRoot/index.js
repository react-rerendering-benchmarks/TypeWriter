...
import { getDocsVersionSearchTag, DocsVersionProvider } from '@docusaurus/plugin-content-docs/client';
...
function DocVersionRootMetadata(props) {
  ...
  return <>
            <SearchMetadata version={version.version} tag={getDocsVersionSearchTag(version.pluginId, version.version)} />
            <PageMetadata>
...
function DocVersionRootContent(props) {
  ...
  return <HtmlClassNameProvider className={version.className}>
