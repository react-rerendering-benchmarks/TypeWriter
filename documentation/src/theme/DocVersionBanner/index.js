...
const LatestVersionSuggestionLabel = memo(function LatestVersionSuggestionLabel({
  versionLabel,
  to,
  onClick
}) {
  ...
  return <Translate id="theme.docs.versions.latestVersionSuggestionLabel" description="The label used to tell the user to check the latest version" values={{
    ...
    latestVersionLink: <b>
                        <Link to={to} onClick={onClick}>
                            <Translate id="theme.docs.versions.latestVersionLinkLabel" description="The label used for the latest version suggestion link label">
                                latest version
                            </Translate>
                        </Link>
                    </b>
...
function DocVersionBannerEnabled({
  ...
  return <Admonition type="danger" title={title}>
            <div className={clsx(className, ThemeClassNames.docs.docVersionBanner)} role="alert">
                <div>
                    <BannerLabel siteTitle={siteTitle} versionMetadata={versionMetadata} />
                </div>
                <div className="margin-top--md">
                    <LatestVersionSuggestionLabel versionLabel={latestVersionSuggestion.label} to={latestVersionSuggestedDoc.path} onClick={useCallback(() => savePreferredVersionName(latestVersionSuggestion.name), [])} />
                </div>
            </div>
        </Admonition>;
}
