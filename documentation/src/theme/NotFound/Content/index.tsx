...
export default function NotFoundContent({
  ...
  return <main className={clsx("container mx-auto flex flex-col items-center justify-center min-h-screen text-center", className)}>
            <div className="flex flex-col lg:flex-row items-center justify-center w-full lg:max-w-5xl spacing-x-12">
                <div className="w-full h-full flex justify-center">
                    <Rive className="w-full h-full aspect-[1644.16/1000]" src={require('@site/static/rive/robot.riv').default} stateMachines="State Machine 1" />
                </div>
